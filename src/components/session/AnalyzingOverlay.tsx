 ...
 *
 * Shows a spinner and stage labels as analysis progresses.
 * For short sessions (<2 min), stages fly by fast.
 * For longer sessions, user can see meaningful progress.
 */
...
export default function AnalyzingOverlay({ visible, progress }: Props) {
  ...
  const totalStages = Object.keys(ANALYSIS_STAGE_LABELS).length - 1; // minus 'complete'
  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{ color: '#8B8B94', fontFamily: 'DM Sans, sans-serif' }}
      >
        {stageLabel}
      </p>
